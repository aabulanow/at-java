...
public class RegistrationPageHT {
    SelenideElement
    ...
    public void changeRegistrationParams(String fio, String passport, String email, String phone) {
    ...
    @Step("Появилась ошибка Заполните все поля")
    public void isErrorFillEmail() {
        this.message.shouldHave(text("Пожалуйста, введите корректный email адрес."));
    }
}
